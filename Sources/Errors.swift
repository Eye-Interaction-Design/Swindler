...
func unexpectedError(
    _ error: String, onElement element: some UIElementType, file: String = #file, line: Int = #line
) {
...
func unexpectedError(
    _ error: Error, onElement element: some UIElementType, file: String = #file, line: Int = #line
) {
